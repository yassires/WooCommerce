...
$wp_customize->add_control(
	new OneStore_Customize_Control_Heading(
		$wp_customize,
		'header_heading_hotline',
		array(
			'section'     => $section,
			'settings'    => array(),
			/* translators: %s: number of HTML element. */
			'label'       => sprintf( esc_html__( 'Hotline', 'onestore' ), $i ),
			'priority'    => $start,
		)
	)
);
...
$wp_customize->add_control(
	...
	array(
		'type'        => 'text',
		'section'     => $section,
		'label'       => sprintf( esc_html__( 'Hotline subtitle', 'onestore' ), $i ),
		'priority'    => $start,
	)
);

// Phone URL.
$key = 'header_hotline_url';
$wp_customize->add_setting(
	$key,
	array(
		'default'     => onestore_array_value( $defaults, $key ),
...
$wp_customize->add_control(
	...
	array(
		'type'        => 'text',
		'section'     => $section,
		'label'       => sprintf( esc_html__( 'Phone URL', 'onestore' ), $i ),
		'priority'    => $start,
	)
);

// Phone Number.
$key = 'header_hotline_number';
$wp_customize->add_setting(
	$key,
	array(
		'default'     => onestore_array_value( $defaults, $key ),
...
$wp_customize->add_control(
	...
	array(
		'type'        => 'text',
		'section'     => $section,
		'label'       => sprintf( esc_html__( 'Phone Number', 'onestore' ), $i ),
		'priority'    => $start,
	)
);

// icon.
$key = 'header_hotline_icon';
$wp_customize->add_setting(
	$key,
	array(
		'default'     => onestore_array_value( $defaults, $key ),
...
$wp_customize->add_control(
	...
	array(
		'type'        => 'text',
		'section'     => $section,
		'label'       => sprintf( esc_html__( 'Hotline Icon', 'onestore' ), $i ),
		'priority'    => $start,
	)
);
...
if ( isset( $wp_customize->selective_refresh ) ) {
	$wp_customize->selective_refresh->add_partial(
		...
		array(
			...
			'render_callback'     => 'onestore_header_element__hotline',
